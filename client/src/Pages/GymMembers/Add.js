...
export default function Add (){
 ...
 function updateForm(value) {
  ...
  async function onSubmit(e) {
    ...
    await fetch("http://localhost:4000/gymmember/add", {
      method: "POST",
      headers: {
                ...
                <div className="example col-8">
                    <form onSubmit={onSubmit} enctype="multipart/form-data">
                        ...
                        <div className="form-group row">
                                ...
                                <input type="text" className="form-control" name="memberid" id="memberid" autoComplete="off" 
                                    value={form.memberid}
                        ...
                        <hr/>
                            ...
                            <div className="form-group row">
                                    <div className="col-md-9">
                                    <button type="submit" className="btn btn-primary mr-1">Save Member</button>
